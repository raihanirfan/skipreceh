...
const HTTP = /^https?:\/\//i;
export const SAFE_PARAMS = new Set(["url","u","link","go","site","r","target","dst","href","s"]);
...
export function isShortener(host){
  return /^(?:bit\.ly|cutt\.ly|rebrand\.ly|shorter\.me|t\.ly|tiny\.cc|tinyurl\.com|shorturl\.at)$/i.test(host.toLowerCase());
}
